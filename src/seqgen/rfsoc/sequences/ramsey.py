...
class RamseySequence(RFSocSequence):
    """RFSoC Ramsey sequence builder: pi/2 - tau - pi/2, sweeping tau."""
    ...
    def load(
        ...
        **kwargs,
        ...
        if sweep_x is None:
            logger.error("sweep_x (free evolution times) must be provided for the Ramsey sequence.")
            return
        ...
        for tau in self.time_list:
            ...
            sig_body = [
                ...
                (CAMERA, frequency, PHASE_X, 0, tau, False),
            ...
            if b_ref:
                if ref_mode == "no_rf":
                    ...
                    ref_body = [
                        ...
                        (CAMERA, holdFreq, PHASE_X, 0, tau, False),
